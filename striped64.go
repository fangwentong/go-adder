...
func (s *striped64) longAccumulate(x int64, fn func(int64, int64) int64, wasUncontended bool, index int32, ctx context.Context) {
	if index == 0 {
		index = initProbe(ctx)
		wasUncontended = true
	}
...
func advanceProbe(probe int32, ctx context.Context) int32 {
